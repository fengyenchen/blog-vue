...
import { getUsernameByUserId } from '../services/users.ts'
          ...
          >
            ...
            <div class="grid grid-cols-2 gap-2">
              <button 
                ...
                class="bg-primary hover:bg-primary/90 border border-primary text-white py-2 rounded text-sm font-medium transition cursor-pointer text-center"
              >
                同意
              </button>
              <button 
              ...
              <tr v-for="app in applications" :key="app.id" class="hover:bg-gray-50/70 transition">
                ...
                <td class="p-4 text-center">
                  <div class="flex justify-center gap-2">
                    <button 
                      @click="handleReview(app.id, app.user_id, 'approve')"
                      class="bg-primary hover:bg-primary/90 border border-primary text-white px-3 py-1.5 rounded text-xs font-medium transition cursor-pointer"
                    >
                      同意
                    </button>
                    <button 
